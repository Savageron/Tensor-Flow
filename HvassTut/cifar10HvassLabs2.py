...
def optimize(num_iterations):
    ...
    for i in range(num_iterations):
        ...
        if (i_global % 100 == 0) or (i == num_iterations - 1):
            ...
            openfile.write(msg.format(i_global, batch_acc) + "\n")
        ...
        if (i_global % 1000 == 0) or (i == num_iterations - 1):
            ...
            openfile.write("Saved checkpoint."+ "\n")
    ...
    openfile.write("Time usage: " + str(timedelta(seconds=int(round(time_dif)))) + "\n")
...
import cifar10
for i in [[1002,1002,64,20],[411,411,64,50],[207,207,64,100],[105,105,64,200]]: #[42,64,42,500],[3501,3501,64,5],[1911,1911,64,10],
    for j in ["Trial1"]:#,"Trial2","Trial3"]:
        #xxx = "Don't run"
        xxx = "Run"
        num_iterations = i[1]
        train_batch_size = i[2]
        imgchosen = 2473 #Bat cuz increased sample size and not always the same!
        Numberoftrainingsamples = i[0]
        Numberoftestsamples = int(21000-Numberoftrainingsamples)
        _images_per_file = int(Numberoftrainingsamples/3)
        _num_files_train = 3 #5
        _num_images_train = _num_files_train * _images_per_file
        data_path = "D:/Iheya_n/HvassTutResults/2BatSCrNSe/NewResults/1to{}ratio/{}/".format(i[3],j) #data_path = cifar10.data_path
        data_path1 = "D:/Iheya_n/HvassTutResults/2BatSCrNSe/NewResults/1to{}ratio/".format(i[3])
        ...
        openfile.write("size of:\n- Training-set:\t\t{}\n- Test-set:\t\t{}\n".format(len(images_train),len(images_test)))
